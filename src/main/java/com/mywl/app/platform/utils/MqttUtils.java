...
public class MqttUtils {
	 ...
	 * @param channelName
	 */
	public static void sendMessage(String topic, byte[] message, int qos, boolean retained, String channelName) {
	 ...
	 * @param channelName
	 */
	public static void sendMessage(String topic, String message, int qos, boolean retained, String channelName) {
		MqttPahoMessageHandler handler = getHandler(channelName);
